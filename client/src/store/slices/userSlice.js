...
export const fetchAllUsers = () => async (dispatch) => {
  ...
  await axios
    .get("https://library-management-system-me5l.onrender.com/api/v1/user/all", { withCredentials: true })
    .then((res) => {
...
export const addNewAdmin = (data) => async (dispatch) => {
  ...
  await axios
    .post("https://library-management-system-me5l.onrender.com/api/v1/user/add/new-admin",data, {
