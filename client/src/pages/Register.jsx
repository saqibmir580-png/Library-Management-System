...
import kashmirlogo from "../assets/University of Kashmir logo (1).jpeg";
        ...
        <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px]">
          <div className="text-center h-[376px]">
            ...
            <p className="text-gray-300 mb-12">
              Alreay have Account? Sign in now.
            </p>
            <Link
              to={"/login"}
              className="border-2 rounded-lg font-semibold py-2 px-8 hover:bg-white hover:text-black transition"
            >
              SIGIN IN
            </Link>
          </div>
